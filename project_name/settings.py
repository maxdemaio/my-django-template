...
if DEBUG:
    ...
    # Add project domain names to this array
    ALLOWED_HOSTS = []
...
# Check if we are in a development or a production environment
# PostgreSQL if production, SQLite if development
if HEROKU:
    DATABASES = {
...
# Setup folder for all static files for collect static on deployment
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")

STATIC_URL = '/static/'

# We can use the static folder for global static files
# Tutorial regarding global static files: https://www.youtube.com/watch?v=kqyfEz7TNI0
STATICFILES_DIRS = [
